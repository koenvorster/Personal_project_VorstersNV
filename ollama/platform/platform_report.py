...
try:
    from ..agents.agent_versioning import (
        AgentLifecycle,
...
try:
    from ..observability.cost_forecaster import CostForecaster, get_cost_forecaster
...
class WeeklyReportGenerator:
    ...
    def _bereken_kost_trend(self, week: str) -> KostEfficientieTrend | None:
        ...
        try:
            ...
            from ..observability.cost_forecaster import CHUNK_VERWERKINGSTIJD
