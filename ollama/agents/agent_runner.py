...
from ..core.memory import ContextAssembler, get_context_assembler
from ..observability.prompt_iterator import PromptIterator

# Optionele ReasoningLogger — als import mislukt, gewoon doorgaan
try:
    from ..observability.reasoning_logger import get_reasoning_logger as _get_reasoning_logger
